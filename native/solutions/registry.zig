...
pub const items = [_]Entry{
    ...
    entry(.year_2015, .day_03, .part_one, index.solver_2015_03_01),
    ...
    entry(.year_2015, .day_06, .part_one, index.solver_2015_06_01),
    entry(.year_2015, .day_06, .part_two, index.solver_2015_06_02),
};
